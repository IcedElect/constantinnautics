...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210724_woodmart_509571a58daf66ac7212_20210724111012_archive.zip';
	const ARCHIVE_SIZE		 = '84695914';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '509571a-24111012';
    const SECONDARY_PACKAGE_HASH = 'bd55ca0-24111012';
	const VERSION			 = '1.4.2';
